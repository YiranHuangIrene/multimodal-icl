...
if __name__ == "__main__":
    ...
    if encoder == "mlp":
        ckpt_path_enc = f"./outs_encoder_mlp/K{K2}_eps{eps0}_input_dim{D2}_hidden_sizes{[D1]}_output_dim{D1//2}_niter50000/seed_0/ckpt_49999.pt"
    elif encoder == "transformer":
        ckpt_path_enc = f"./outs_encoder_transformer/K{K2}_eps{eps0}_feat_dim{D2}_input_dim128_output_dim{D1//2}_num_layers2_num_heads1_niter50000/seed_0/ckpt_49999.pt"
    # Training parameters
