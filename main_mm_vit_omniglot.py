...
if __name__ == "__main__":
    ...
    # Training parameters
    niters = 70000  # Number of iterations
   ...
   # Initialize wandb
    prefix = f"./outs_torch/Omniglot_K2_{K2}_n_img_{n_img_per_class}_eps_{eps0}_a_{alpha0}_rotate_{rotate}_crop_{crop}_dropout_{dropout}_l1_lambda_{l1_lambda}_l2_lambda_{l2_lambda}_out_dim_{D2}_MM_K1_{K1}_L1_{L1}_L2_{L2}_a1_{alpha1}_a2_{alpha2}_B{B}_pB{p_B}_pC{p_C}_eps1_{eps1}_eps2_{eps2}_layers{freeze_layers}_encoder{freeze_encoder}"
    if WANDB:
